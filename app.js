alert('Lia?');
alert("U know WHO AM I?");
alert('Gua temen SMA LO li');
alert('Sekarang lo udah 20 aja');
alert('Semoga lo sehat terus yaa lia');
alert('Dapat cowok yang lo inginkan');
alert('Gua gaberani confess ke lo lia');
alert('Maafin gua yaa kalau ada salah sama lo.');
alert('Semoga diumur 20 tahun ini lo menjadi pribadi yang lebih kuat dan baik');

alert('Sorry gua cuma bisa ngasih tulisan ini :") makasih sekali lagi Lia');
...
const customText = urlParams.get('text') || 'Happy Birthday SITI AMALIA AGUSTIN, Selamat datang diumur 20';
const space = '                        ';
